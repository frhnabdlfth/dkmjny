...
class JadwalBase(BaseModel):
    ...
    kategori_imam: str
    khatib: str = Field(default=None, min_length=2, max_length=255)
    kategori_khatib: str = Field(default=None)
    muadzin: str = Field(default=None, min_length=2, max_length=255)
    kategori_muadzin: str = Field(default=None)
